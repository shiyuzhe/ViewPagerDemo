...
import zhj.viewpagerdemo.trans.utilities.ValueInterpolator;

/**
 * Created by Bartosz Lipinski
 * 28.01.15
 */
public class StackPageTransformer2 implements ViewPager.PageTransformer {
     ...
     *                         bounds.
     */
    public StackPageTransformer2(int numberOfStacked, float currentPageScale, float topStackedScale, float overlapFactor, Gravity gravity) {
    ...
    public void transformPage(View view, float position) {
        ...
        if (position < -mNumberOfStacked - 1) {
            ...
            Log.e("viewpager", "mZeroPositionScale:" + mZeroPositionScale + "_scale:" + scale);
